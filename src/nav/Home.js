...
function game(){
  ...
  return (
    <div>
      <section>
        ...
        <SwiperSlide><img src='https://i03.appmifile.com/55_operator_in/04/04/2025/1e11c8a3ec194a851475a9da6168d359.png?thumb=1&w=2560&f=webp&q=85'></img></SwiperSlide>
        <SwiperSlide><img src='https://i03.appmifile.com/884_operator_in/04/11/2024/69aba3a4a5d706db1a458b659e7ce39a.png?thumb=1&w=2560&f=webp&q=85'></img></SwiperSlide>
      </Swiper>
 ...
 <div className='container'>
  <div className='row'>
    <div className='col-4'>
      <div class="card but">
        <img src='https://i02.appmifile.com/38_operatorx_operatorx_xm/27/11/2024/f7184560e02644c9c4cf5d23b0618c6c.png?thumb=1&f=webp&q=85'></img>
  <div class="card-body">
  <h2 style={{fontWeight:"bolder",textAlign:"center"}}>Exclusive Bundels</h2>
    ...
    <div className='col-4'>
    <div class="card but">
    <img src='https://i03.appmifile.com/823_operator_in/16/06/2025/e5ae94971baf9c77036f348a6afea1e3.jpg?thumb=1&f=webp&q=85'></img>
   <div class="card-body">
   <h2 style={{fontWeight:"bolder",textAlign:"center"}}>Spcial Rewards</h2>
    <button className='btn btn-dark lern' style={{textAlign:"center"}}>Learn More</button>
      ...
      <div className='col-4'>
      <div class="card but">
        <img src='https://i02.appmifile.com/500_operatorx_operatorx_xm/27/11/2024/9ea7b5fd29f11b0100e9a0b6d3eeebe8.png?thumb=1&f=webp&q=85'></img>
  <div class="card-body">
